...
class GrammarD3 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    componentDidMount() {
        ...
        for (let i = 0; i < response.data.data_question.length; i += 1) {
            ...
            for (
                ...
                // console.log("=====grammar",response.data.data_question[i].list_option[j].content_question)
    ...
    _showKeyBoad = () => {
        this.props.handleKeyboardShow(-(SmartScreenBase.smPercenHeight*100 / 4 - SmartScreenBase.smPercenHeight * 2));
    };
    _HideKeyBoad = () => {
        ...
        return (
            <View style={{ width: SmartScreenBase.smPercenWidth*100 }}>
                <ScrollView style={{
                    ...
                    width: SmartScreenBase.smPercenWidth*100 * 0.9,
                    backgroundColor: '#FFF',
                    marginLeft: SmartScreenBase.smPercenWidth*100 * 0.05,
                                ...
                                <View
                                    style={
                                        (StyleLesson.Sty_View_Border,
                                        {
                                            ...
                                            borderColor: '#FF9933',
                                            width: SmartScreenBase.smPercenWidth*100 * 0.9 - 2 * SmartScreenBase.smPercenHeight,
                                            alignSelf: 'center',
                                    ...
                                    <ScrollView>
                                        <View style={{
                                            ...
                                            flexWrap: 'wrap',
                                            zIndex: 0,
                                            width: SmartScreenBase.smPercenWidth*100 * 0.9 - 6 * SmartScreenBase.smPercenHeight,
                                        }}>
    ...
    _onCheckNumberRight = () => {
        ...
        this.setState({
            ...
            const isRight = number === data.length
        ...
        return (
            <View style={style.RenderQuestionView}>
                ...
                <View style={{ marginBottom: 5, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    />
                    <View style={{ width: SmartScreenBase.smPercenWidth*100 * 0.7, marginBottom: Platform.OS === 'ios' ? 20 : 0 }}>
        ...
        return (
            <View
                ...
                <View style={{flexDirection: 'row'}}>
                    ...
                    />
                    <View style={{ width: SmartScreenBase.smPercenWidth*100 * 0.7, marginBottom: 20 }}>
                        <View
                            style={{
                                // height: SmartScreenBase.smBaseWidth * 112,
                                justifyContent: 'center',
                            ...
                            <Text style={{
                                ...
                                width: SmartScreenBase.smPercenWidth*72,
                            }}>
                                {`${myAns.ans.replace(/\n/g, ' ')}`}
                            </Text>
                        </View>
                ...
                </View>
                {
                        ...
                        style={{
                                //height: SmartScreenBase.smBaseWidth * 112,
                                width: SmartScreenBase.smPercenWidth*100 * 0.75,
                                flexDirection: 'row',
                                alignItems: 'center',
                                        ...
                                        : null}
                {
                    this.state.checktype === 'afterTest' ?
                        <View
                            style={{
                                width: SmartScreenBase.smPercenWidth*100,
                                height: SmartScreenBase.smPercenHeight*100 * 0.1,
                                justifyContent: 'center',
                                alignItems: 'center',
                                flexDirection: 'row',
                            }}>
                    ...
                    this.state.checktype === 'exam' ? (
                        ...
                        <View
                            ...
                            <TouchableOpacity
                                ...
                                style={{
                                    width: SmartScreenBase.smPercenWidth*100 * 0.55,
                                    height: SmartScreenBase.smPercenHeight*100 * 0.05,
                                    backgroundColor: '#01283A',
                                    borderRadius: SmartScreenBase.smPercenHeight*100 * 0.025,
                                    justifyContent: 'center',
                                    alignItems: 'center',
                                    marginTop: SmartScreenBase.smPercenHeight*100 * 0.02,
                                }}>
                                <Text style={stylesApp.Sty_Text_Button}>TIẾP TỤC</Text>
                            </TouchableOpacity>
                        </View>
...
export default connect(mapStateToProps)(GrammarD3);
