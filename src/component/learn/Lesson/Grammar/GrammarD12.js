...
class GrammarD12 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
                        ...
                        {this.state.ArrAnswer[index].status === true ? (
                            ...
                            <TextInput
                                ...
                                style={{
                                    ...
                                    padding:0,
                                    paddingTop:Platform.OS==='ios'?-SmartScreenBase.smPercenWidth:SmartScreenBase.smPercenWidth,
                                }}
                                placeholder={'Trả lời...'}
                                autoCapitalize={'none'}
                                multiline={true}
    ...
    _ItemHintQuestion2 = ({item,index})=>{
        ...
        return (
            <View style={[style.RenderQuestionView,{position:'relative'}]}>
                {
                    my_ans.status&&<Image
                    source={{
                        uri:'grammar1_4'
                ...
                </View>
                {
                        ...
                        style={{
                            ...
                            fontSize: SmartScreenBase.smFontSize * 50,
                                ...
                                {`${this.dataHint[index]} ${item.answer}`}
                            </Text>
                        </View>
                    }
            </View>
                            ...
                            {this.state.statusScreen === 'question' ? (
                                ...
                                this.state.statusScreen === 'ShowHintDetailQuestion' ?
                                    <TouchableOpacity
                                        ...
                                        <Text style={stylesApp.Sty_Text_Button}>{this.state.TextButtonDetainQuestionHint}</Text>
                                    </TouchableOpacity>
                                    : this.state.statusScreen === 'ShowListDetailHind' ?
                                    <View>
                                        <TouchableOpacity
...
export default connect(mapStateToProps)(GrammarD12);
