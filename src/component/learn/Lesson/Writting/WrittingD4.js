...
import { ActionWrittingD4 } from '../../../../redux/actions/ActionWrittingD4';
...
class WrittingD4 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    componentDidMount() {
        ...
        for (let i = 0; i < response.data.data_question.length; i += 1) {
            ...
            for (
                ...
                console.log("=====ar",response.data.data_question[i].list_option[j].match_option_text)
                DataObject2.explain = "";
                    ...
                    <View
                        ...
                        {arr.map((e, index, key) => {
                            return (
                                <View style={{}}>
                                    <TouchableOpacity
                                        onLongPress={() => this.moveWedView(e.toLowerCase())}
            ...
            <View
                ...
                <View style={{flexDirection: 'row'}}>
                    ...
                    <View style={{ width: width * 0.7, marginBottom: 20 }}>
                        <View
                            style={{
                                minHeight: SmartScreenBase.smBaseWidth * 112,
                                justifyContent: 'center',
                                // alignItems: 'center',
                            }}>
                            <Text style={{
...
function mapStateToProps(state) {
    return {
        data_answer: state.WrittingD4Reducer.data_answer,
        data_login: state.AuthStackReducer.dataLogin,
    };
}

export default connect(mapStateToProps)(WrittingD4);
