...
import WrittingD4Reducer from '../../../../redux/reducers/WrittingD4Reducer';
import {ActionWrittingD3} from '../../../../redux/actions/ActionWrittingD3';
import stringUtils from '../../../../../src/utils/stringUtils' 
import LessonBase from '../../../../base/LessonBase';
import FontBase from '../../../../base/FontBase';
import { InputWithFixText } from '../../../../componentBase/InputWithFixText/InputWithFixText';
...
class WrittingD3 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
        ...
        return (
            <View style={style.RenderQuestionView}>
                ...
                <View style={{marginBottom: SmartScreenBase.smPercenWidth*5,
                    ...
                    />
                    <InputWithFixText 
                        textFix={this.dataHint[index]} 
                        ansText={this.state.ArrAnswer[index].ans}
                        status={this.state.ArrAnswer[index].status}
        ...
        return (
            <View style={style.RenderQuestionView}>
                <View
                    ...
                    <Text style={{fontFamily: FontBase.MyriadPro_Bold, ...StyleLesson.question_text}}>{index + 1}. </Text>
                    {arr.map((e, index, key) => {
                        return (
                            <View style={{}}>
                                <TouchableOpacity
                                    onLongPress={() => LessonBase.goTranslate(e)}
                                    style={[stylesApp.txt, {zIndex: 0}]}>
                                    <Text style={{fontFamily: FontBase.MyriadPro_Regular, ...StyleLesson.question_text}}>
                                        {e}{' '}
                                    </Text>
                                </TouchableOpacity>
                            </View>
        ...
        return (
            <View style={{
                    ...
                    style={{flexDirection:'row',flexWrap:'wrap',marginBottom:SmartScreenBase.smPercenWidth*3}}>
                            {
                                ...
                                disabled={true}
                                key={i}>
                                <Text style={{ color: (c.show || this.state.showFullHint) ? 'black' : '#FF9933', fontSize: SmartScreenBase.smFontSize * 40 }}>{c.text}</Text>
                            </TouchableOpacity>)
                        }
                    </View>
                }
                <View style={{marginBottom: SmartScreenBase.smPercenWidth*5,
                     flexDirection: 'row', alignItems: 'center',}}>
                    <Image
                        source={{ uri: my_ans.status ? 'grammar1_4' : 'lesson_grammar_image1' }}
                        style={{
                            width: SmartScreenBase.smBaseWidth * 112,
                            height: SmartScreenBase.smBaseWidth * 112,
                            marginLeft: SmartScreenBase.smPercenHeight,
    ...
    _ShowResultNotDone = () => {
        ...
        return (
            <View style={{width: width}}>
                <View style={{
                    height: SmartScreenBase.smPercenHeight * (isIcon?15:1),
                    width: '100%',
                    justifyContent: 'center',
                    alignItems: 'center',
                }}>
                ...
                <View
                    style={{
                        height: SmartScreenBase.smPercenHeight * (isIcon?50:64),
                        width: width,
        ...
        return (
            <View
                ...
                <View
                    ...
                    <Text style={StyleLesson.answer_text}>{index + 1}. </Text>
                    {arr.map((e, index) => {
                        return (
                            <View style={{}} key={index}>
                                <TouchableOpacity
                                    ...
                                    style={[stylesApp.txt, {zIndex: 0}]}>
                                    <Text
                                        style={{...StyleLesson.answer_text, fontFamily: FontBase.MyriadPro_Regular}}>
                                        {e}{' '}
                                    </Text>
                                </TouchableOpacity>
                            </View>
                ...
                <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                    ...
                    <View style={{
                        ...
                        <Text >
                            <Text style={StyleLesson.answer_text}>
                                {this.dataHint[index]} {' '}</Text>
                            <Text style={{
                                ...StyleLesson.answer_text,
                                color: myAns.status?'#72B228':'#D80B0B',
                            }}>
                                {`${myAns.ans.replace(/\n/g, ' ')}`}
                            </Text>
                        </Text>
                ...
                </View>
                {
                        ...
                        style={{
                            ...
                            <Text style={{marginLeft: 5, color: '#72B228', ...StyleLesson.answer_text}}>
                                {`${this.dataHint[index]}`} {this.state.data[index].answer}
                            </Text>
                        </View>
                    }
            </View>
            ...
            <View style={{
                ...
                <View style={{ width, alignItems: 'center' }}>
                    <View style={{ alignSelf: 'center' }}>
                        <FileSound showIcon={'none'} showImage={this.state.numberRightEx === this.state.data.length ? 'true' : 'false'} />
                    </View>
                    <Text style={StyleLesson.text_answer}>
                        BẠN ĐÃ TRẢ LỜI ĐÚNG {this.state.numberRightEx}/
                        {this.state.data.length}
                ...
                <View
                    style={{
                        height: SmartScreenBase.smPercenHeight * (isRight?50:64),
                        width: width,
                        marginBottom: SmartScreenBase.smPercenHeight * 3,
                    }}>
                    <FlatList
                        ...
                        <View>
                            ...
                            <View
                                ...
                                <View style={{
                                    ...
                                    <Text>
                                        <Text style={{fontFamily: FontBase.MyriadPro_Bold, fontSize:SmartScreenBase.smFontSize*45}}>
                                            {this.dataHint[index]} {' '}</Text>
                                        <Text style={{
        ...
        return (
            <View
                ...
                <View
                    ...
                    <Text style={{...StyleLesson.question_text}}>
                        <Text style={{fontFamily: FontBase.MyriadPro_Regular, ...StyleLesson.question_text}}>{index + 1}. </Text>
                        {this.state.data[index].question === ''
                            ? ''
                            : this.state.data[index].question.toLowerCase()}
                    </Text>
                </View>
                {this._ShowScriptItem(index)}
            </View>
    ...
    _OnPressCheckDetailHintQuesstion = () => {
        ...
        if (this.state.TextButtonDetainQuestionHint === 'Kiểm Tra') {
            ...
            // let checkListOp = this.state.data[this.state.indexOfQuestionHint].Listanswer.findIndex(items1 =>
            //     Utils.validWord(this.state.ArrAnswer[this.state.indexOfQuestionHint].ans.toLowerCase()) ===
            //     Utils.validWord(items1.toLowerCase()));
            if (checkListOp) {
...
function mapStateToProps(state) {
    return {
        data_answer: state.WrittingD3Reducer.data_answer,
        data_login: state.AuthStackReducer.dataLogin,
    };
}

export default connect(mapStateToProps)(WrittingD3);
