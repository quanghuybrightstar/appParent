...
import SettingNotification from '../../src/screens/Teacher/SettingNotification';
...
import ChooseClass from '../screens/ChooseClass';
...
import {
    ClassListTeacherScreen, ClassDetailTeacherScreen, CreateClassTeacherScreen, ManageClassEnrollmentScreen, StudentListTeacherScreen, AttendanceManagementTeacherScreen, AddStudentOnlineScreen,
    AttendancePaperTeacherScreen, ViewAttendanceTeacherScreen, AttendanceCardTeacherScreen, ScoreManagementScreen, ScoreManagementScreenDetail,
    MarkScreen, MarkDetailScreen, MarkProjectScreen, EditClassTeacherScreen
...
import { ManagingAssignmentsParentScreen } from '../screens/ParentNews/AssignExercise';
...
const workDeliveredStack = createStackNavigator(
    {
...
const StudenStack = createStackNavigator(
    {
        Home,
        ListStudenScreen,
    }
...
const Curriculum = createStackNavigator(
    {
        CourseListTCScreen,
    },
    {
...
const ChatStack = createStackNavigator(
    {
        ChooseClass: { screen: ChooseClass },
    },
    {
        headerMode: 'none'
    });

const BottomTeacher = createBottomTabNavigator(
    {
        'Home': {
            screen: StudenStack,
            navigationOptions: () => ({
                ...
                tabBarIcon: ({ focused, tintColor }) => {
                    return (
                        <Image
                            ...
                            source={{ uri: focused ? 'icon_manager_active' : 'class_manager' }}
                        />
                    );
                },
            }),
                ...
                tabBarIcon: ({ tintColor, focused }) => {
                    return (
                        <Image
                            ...
                            source={{ uri: focused ? 'icon_messeger_active' : 'message_icon_bottom' }}
                        />
                    );
                },
            }),
...
// teacher
const ListenOnlineStack = createStackNavigator(
    {
        BottomTeacher,
        ClassListScreen,
        StudenStack,
        ...
        OtherSetting,
        ManageAssign, DetailManageAssign,
        TeacherProfile,
        EditProfileTeacher,
        WorkMenu,
        WorkSchedule,
...
export default ListenOnlineStack;
