...
export const styles = StyleSheet.create({
    imageBanner: {
        alignSelf: 'center',
        marginTop: SmartScreenBase.smBaseHeight * 134,
    ...
    viewbtn: { position: 'absolute', bottom: SmartScreenBase.smBaseHeight * 40, alignSelf: 'center' },
    row: {
        flexDirection: 'row',
        alignItems: 'center'
    },
    ...
    footerItem: {
        position: 'absolute',
        bottom: SmartScreenBase.smBaseWidth * 20, right: 0,
        alignItems: 'flex-end',
        flexDirection: 'row',
    ...
    lesson_topic: { ...FontWeight.Bold, lineHeight: Platform.OS === 'ios' ? FontSize.size50Font : FontSize.size55Font },
    txtCurriculum: { width: SmartScreenBase.smPercenWidth * 75, },
    flex1: { flex: 1 },
    btn: { alignSelf: 'center', marginVertical: SmartScreenBase.smBaseWidth * 60 },
    txtEmpty: { alignSelf: 'center', marginVertical: SmartScreenBase.smBaseHeight * 15 },
