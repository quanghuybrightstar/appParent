            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={{
                        position:'absolute',
                        right:10,
                        top:SmartScreenBase.smPercenWidth * 7,
                        zIndex:10
                    }}
                    onPress={()=>{this._onChoiceStudent(index)}}
                    >
    ...
    render() {
        return (
            <ImageBackground source={{uri: 'imagebackground'}} style={{
                ...
                <Header navigation={this.props.navigation} title={'Chờ duyệt'}/>
