...
#import <React-RCTText/RCTText/RCTUITextView.h>


#import "RNSelectableTextView.h"

#import <React-RCTText/RCTText/RCTTextAttributes.h>
...
NSString *const MY_CUSTOM_SELECTOR = @"_CUSTOM_SELECTOR_";
...
-(void) _handleGesture
{
    ...
    for(NSString *menuItemName in self.menuItems) {
        NSString *sel = [NSString stringWithFormat:@"%@%@", MY_CUSTOM_SELECTOR, menuItemName];
...
- (void)forwardInvocation:(NSInvocation *)invocation
{
    ...
    NSRange match = [sel rangeOfString:MY_CUSTOM_SELECTOR];
    if (match.location == 0) {
